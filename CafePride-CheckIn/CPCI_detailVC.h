...
#import "Btn_AttendanceEligibility.h"
#import "Popover_DatePicker.h"
#import "Popover_ImagePicker.h"


@interface CPCI_detailVC : UIViewController <UIImagePickerControllerDelegate, Popover_ImagePickerDelegate, UIPopoverControllerDelegate, UIAlertViewDelegate>
{
    // Attendance buttons for setting the current or initial attendance status
    Btn_Attendance *attendanceButtons;
    Btn_AttendanceEligibility *eligibilityButtons;
}
...
@property (strong, nonatomic) IBOutlet UILabel *label_AttendanceStatus;
